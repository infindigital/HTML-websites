...
//
//  NOTE: Names (Rayyan, Inaya, parents), the venue name & address, the
...
export const translations = {
  ...
  en: {
    ...
    nameBrideFull: 'Inaya Sheikh',
    nameGroomParentage: 'S/O. Imran Ahmed & Zoya',
    nameBrideParentage: 'D/O. Faisal Sheikh & Ayesha',
    ...
    venueShort: 'Hyderabad, Telangana',
    scroll: 'SCROLL',
  ...
  kn: {
    ...
    nameGroomFull: 'ರಯ್ಯಾನ್ ಅಹ್ಮದ್',
    nameBrideFull: 'ಇನಾಯಾ ಶೇಖ್',
    nameGroomParentage: 'ಪುತ್ರ · ಇಮ್ರಾನ್ ಅಹ್ಮದ್ & ಝೋಯಾ',
    nameBrideParentage: 'ಪುತ್ರಿ · ಫೈಸಲ್ ಶೇಖ್ & ಆಯೇಷಾ',
  ...
  hi: {
    ...
    nameBrideFull: 'इनाया शेख़',
    nameGroomParentage: 'पुत्र · इमरान अहमद & ज़ोया',
    nameBrideParentage: 'पुत्री · फ़ैसल शेख़ & आयशा',
  ...
  ar: {
    ...
    nameGroomFirst: 'ريان',
    nameBrideFirst: 'عناية',
    nameCombined: 'ريان & عناية',
    nameGroomFull: 'ريان أحمد',
    nameBrideFull: 'عناية شيخ',
    nameGroomParentage: 'ابن · عمران أحمد & زويا',
    nameBrideParentage: 'ابنة · فيصل شيخ & عائشة',
    ...
    venueShort: 'حيدر آباد، تيلانغانا',
    scroll: 'مرّر للأسفل',
