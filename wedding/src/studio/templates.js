...
export const TEMPLATES = [
  mk({
    ...
    previewVideo: '/assets/noor.mp4', poster: '/assets/noor-poster.jpg',
  ...
  mk({
    ...
    previewVideo: '/assets/aaranya.mp4', poster: '/assets/aaranya-poster.jpg',
  ...
  mk({
    ...
    previewVideo: '/assets/celeste.mp4', poster: '/assets/celeste-poster.jpg',
