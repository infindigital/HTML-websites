# Imran PJ &amp; Rashina — Interactive Wedding Invitation
...
Names, date, venue, verse, Bismillah and asset paths. For example:

```js
couple: { groomFirst: 'Imran PJ', brideFirst: 'Rashina', monogram: 'I ✦ R', ... },
date:   { iso: '2026-10-03T11:00:00+05:30', labelUpper: 'SATURDAY, 03 OCTOBER 2026', ... },
venue:  { name: 'Sagar Auditorium', mapQuery: '…', ... },
```
